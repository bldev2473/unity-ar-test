...
/// of a hard edge.
/// </summary>
[RequireComponent(typeof(ARPlaneMeshVisualizerOverride), typeof(MeshRenderer), typeof(ARPlane))]
public class ARFeatheredPlaneMeshVisualizer : MonoBehaviour
{
    ...
    void Awake()
    {
        m_PlaneMeshVisualizerOverride = GetComponent<ARPlaneMeshVisualizerOverride>();
    ...
    {
        GenerateBoundaryUVs(m_PlaneMeshVisualizerOverride.mesh);
    }
    ...
    /// </summary>
    /// <remarks>
    /// The <c>ARPlaneMeshVisualizerOverride</c> has a <c>meshUpdated</c> event that can be used to modify the generated
    ...
    /// is fairly uniform.
    /// </remarks>
    /// <param name="mesh">The <c>Mesh</c> generated by <c>ARPlaneMeshVisualizerOverride</c></param>
    ...
    ARPlaneMeshVisualizerOverride m_PlaneMeshVisualizerOverride;
